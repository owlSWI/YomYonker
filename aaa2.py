...
class Ui_MainWindow2(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "dish2"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:20pt; color:#ff5500;\">Паста с<br/>Томатным соусом</span></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#000000;\">Время приготовления: 40 минут<br/><br/>Сложность: Легкая<br/><br/>Распространенный аллерген:<br/>Сыр</span></p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#000000;\">- Спагетти<br/>- Томаты<br/>- Лук<br/>- Чеснок<br/>- Сыр<br/></span></p></body></html>"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600; color:#000000;\">ИНСТРУКЦИЯ:</span><span style=\" font-size:20pt; color:#000000;\"><br/><br/></span><span style=\" font-size:14pt; color:#000000;\">1. Обжарьте помидоры с<br/>        овощами<br/>2. Сварите Спагетти<br/>3. Соедините</span></p></body></html>"))
