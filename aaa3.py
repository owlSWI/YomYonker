...
class Ui_MainWindow3(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_6.setGeometry(QtCore.QRect(100, 310, 281, 271))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "dish3"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:20pt; color:#ff5500;\">Курица в<br/>ананасовом соусе</span></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#000000;\">Время приготовления: 20 минут<br/><br/>Сложность: средняя<br/><br/>Распространенный аллерген:<br/>Ананас</span></p></body></html>"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#000000;\">- Куриное филе<br/>- Ананасы консерв.<br/>- Лук<br/>- Вода<br/>- Мед<br/>- Крахмал<br/></span></p></body></html>"))
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600; color:#000000;\">ИНСТРУКЦИЯ:</span><span style=\" font-size:20pt; color:#000000;\"><br/><br/></span><span style=\" font-size:14pt; color:#000000;\">1. Обжарьте Кур. филе<br/>2. Добавьте ананасы, мед, воду<br/>3. Добавьте крахмал для густоты<br/>4. Добавьте Специи</span></p></body></html>"))
