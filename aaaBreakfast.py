...
class Ui_MainWindow_Breakfast(object):
...
" padding: 5px;")
        ...
        self.pushButton_10.clicked.connect(self.open_new_window_Breakfast1)  # открытие окна
...
" padding: 5px;")
        ...
        self.pushButton_13.clicked.connect(self.open_new_window_Breakfast2)  # открытие окна
...
" padding: 5px;")
        ...
        self.pushButton_15.clicked.connect(self.open_new_window_Breakfast3)  # открытие окна
    ...
    def open_new_window_Breakfast1(self):
        from aaaBreakfast1 import Ui_MainWindow_Breakfast1
        self.window = QtWidgets.QMainWindow()
        self.ui = Ui_MainWindow_Breakfast1()
        self.ui.setupUi(self.window)
        self.window.show()

    def open_new_window_Breakfast2(self):
        from aaaBreakfast2 import Ui_MainWindow_Breakfast2
        self.window = QtWidgets.QMainWindow()
        self.ui = Ui_MainWindow_Breakfast2()
        self.ui.setupUi(self.window)
        self.window.show()

    def open_new_window_Breakfast3(self):
        from aaaBreakfast3 import Ui_MainWindow_Breakfast3
        self.window = QtWidgets.QMainWindow()
        self.ui = Ui_MainWindow_Breakfast3()
        self.ui.setupUi(self.window)
        self.window.show()
